...
Hoe minder de Koran wordt gelezen, hoe minder men \emph{uit eigen ervaring} weet wat er in staat, met als treurig gevolg dat men zich baseert op informatie van horen-zeggen.  Dit terwijl in de Koran God ons juist opdraagt de Koran (op) te lezen (\ql{2:121}, \ql{35:29}), en te luisteren als deze opgelezen wordt (\ql{7:204}, \ql{39:18}).
...
In de Koran wordt dit al aangekondigd.  Er staat dat men zal proberen het bericht van de Koran te verdraaien (\ql{41:26}, \ql{48:15}) maar dat het niet mogelijk is omdat God het boek heeft beschermd (\ql[56:77-56:81]{56:77}).
\vspace{0.3cm}
